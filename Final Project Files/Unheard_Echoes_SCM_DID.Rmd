...
crimes_women <- read_excel("C:\\Users\\Akash Mittal\\Documents\\GitHub\\Causal Inference\\Crime against Women\\Final Ones\\Master Sheet.xlsx", sheet='Women')

# Load murder data
murders <- read_excel("C:\\Users\\Akash Mittal\\Documents\\GitHub\\Causal Inference\\Crime against Women\\Final Ones\\Master Sheet.xlsx", sheet='Murders')

# Load the Estimated Population Data for different states 
population <- read_excel("C:\\Users\\Akash Mittal\\Documents\\GitHub\\Causal Inference\\Crime against Women\\Final Ones\\India_Population_Estiamtes.xlsx")
...
```{r}
# Below code was used to check states wjhich have missing values for the different perdictor varaibles
